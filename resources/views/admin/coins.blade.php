        ...
        <div class="navbar-vertical-footer-offset">
            ...
            <div class="navbar-vertical-content">
                <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                    ...
                    <div class="nav-item">
                        <a class="nav-link " href="{{route("admin.users")}}" data-placement="left">
                    ...
                    <div class="nav-item">
                        <a class="nav-link " href="" data-placement="left">
                            ...
                            <span class="nav-link-title">Монеты</span>
                        </a>
                    </div>
        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">Монеты</h1>
                </div>
                <!-- End Col -->
                ...
                <div class="col-sm-auto">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        ...
                        <i class="bi-plus me-1"></i> Создать монету
                    </button>
                </div>
                <!-- End Col -->
                        ...
                        <tr id="coin_{{$coin['id']}}">
                            ...
                            <td class="table-column-ps-0">
                                <a class="d-flex align-items-center" href="#">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{$coin['symbol']}}</span>
                                    </div>
                                </a>
                            </td>


                            <td>{{$coin['id_coingap']}}</td>
                            <td>
                                <button onclick="deleteCoin({{$coin['id']}})" type="button" class="btn btn-white btn-sm">
                                    <i class="bi-x-octagon-fill me-1"></i> Удалить
                                </button>
                            </td>
                        </tr>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="createAKIKeyModalLabel">Создать монету</h4>
            ...
            <form id="coin_modal">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex flex-column gap-2">
                        @csrf
                        <input class="form-control" type="text" name="full_name" placeholder="Полное название монеты">
                        <input class="form-control" type="text" name="id_coingap" placeholder="id_монеты в coincap">
                        <input class="form-control" type="text" name="symbol" placeholder="symbol">
...
<div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editUserModalLabel">Добавить монету</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
    ...
    function deleteCoin(id){
        $.ajax({
            ...
            success: function (data) {
                const element = document.getElementById('coin_'+id)
...
<script>
    const coin_modal = document.getElementById("coin_modal");
    coin_modal.addEventListener("submit", function (e) {
        e.preventDefault()
        const form = new FormData(coin_modal)
        $.ajax({
