        ...
        <div class="navbar-vertical-footer-offset">
            ...
            <div class="navbar-vertical-content">
                <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                    ...
                    <div class="nav-item">
                        <a class="nav-link " href="{{route("admin.coins")}}" data-placement="left">
                        ...
                        <tr id="user_{{$user['id']}}">
                            ...
                            <td class="table-column-ps-0">
                                <a class="d-flex align-items-center" href="#">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{$user['email']}}</span>
                                    </div>
                                </a>
                            </td>
                            ...
                            <td>{{$user['role']}}</td>
                            <td>
                                <button onclick="deleteUser({{$user['id']}})" type="button" class="btn btn-white btn-sm">
